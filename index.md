...
- A pilot study on the use of cholera rapid diagnostic tests in routine surveillance
- A multi-country retrospective analysis of the impact of reactive Oral Cholera Vaccine (OCV) campaigns
- An observational study on the [effectiveness of Ebola vaccination](https://doi.org/10.1016/S1473-3099(24)00419-5) using data routinely collected during an outbreak
